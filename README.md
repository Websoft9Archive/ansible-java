...
Core components of this repository: JDK, Nginx, ,Tomcat, Docker, MySQL, phpmyadmin on docker
...
```
$ sudo su -
$ wget -N https://raw.githubusercontent.com/Websoft9/ansible-linux/main/scripts/install.sh; bash install.sh -r java
```
...
Follow our [Java image](https://apps.websoft9.com/java) for installation on major Cloud Platform.

## Documentation

**[Administrator Guide](https://support.websoft9.com/docs/java)** 
