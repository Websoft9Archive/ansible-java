...
The Java deployment package contains a sequence of software (referred to as "components") required for Java to run. Below list the important information, the component name, installation directory path, configuration file path, port, version, etc.
...
| --- | --- | --- | --- |
| TCP | 80 | HTTP to access Java | Required |
| TCP | 443 | HTTPS to access Java | Optional |
| TCP | 3306 | Remote to access MySQL | Optional |
| TCP | 9003 | Use port to access Java | Optional |
| TCP | 9002 | Java Document Server on Docker | Optional |
