...
Here are the required username and password for Java installation and configuration.

## Java

* Java administrator username: `admin`
* Java administrator password: Get it form the file of your server */credentials/password.txt*
